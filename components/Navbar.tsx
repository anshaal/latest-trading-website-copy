      ...
      <div className="max-w-screen-2xl mx-auto px-4 py-4 lg:px-10 lg:py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-12">
            ...
            <a
              href="#pricing"
              className="group inline-flex items-center justify-center space-x-2 bg-white hover:opacity-90 text-black px-6 py-3 rounded-full transition-all duration-200 text-sm sm:text-base"
            >
