    ...
    <div className="relative isolate flex flex-col items-center justify-center min-h-screen p-4 bg-[#11141a]">
      ...
      >
        <div
          ...
          className="relative w-[68.125rem] h-[68.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#d900ff] to-[#2a628d] opacity-70"
        />
      </div>
      ...
      >
        <div
          ...
          className="relative w-[68.125rem] h-[68.125rem] -translate-x-1/2 -translate-y-1/2 rotate-[120deg] bg-gradient-to-tr from-[#0062ff] to-[#aa00ff] opacity-50"
        />
      </div> */}
